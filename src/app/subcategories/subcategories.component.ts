...
export class SubcategoriesComponent implements OnInit {
  ...
  categories: Category[] = [
    { id: 0, name: 'Elektronika', subcategories: ["Audio i hi-fi", "Cesje", "Fotografia i wideo", "Gry wideo i konsole", "Komputery i software", "Radiokomunikacja", "Tablety i bookreadery", "Telefony i akcesoria", "Telewizory i odtwarzacze", "Elektronia inne", "Kupię sprzęt elektroniczny"] },
    ...
    { id: 5, name: 'Usługi', subcategories: ["Biura podróży", "Współpraca biznesowa", "Catering", "Usługi finansowe", "Fotografia i wideo", "Graficy i usługi IT", "Hurt i handel", "Kombutery serwis i handel", "Usługi kurierskie", "Nauka i edukacja", "Mechanika, autoskup, pomoc drogowa", "Media i reklama", "Muzycy i artyści", "Ogrodnictwo", "Opieka i agencje niań", "Pielęgnacja i uroda", "Usługi prawne", "Przeprowadzki i transport towarów", "Przyjęcia, śluby, komunie", "Remont i budowa", "Serwis i montaż", "Sport i fitness", "Sprzątanie", "Taxi i przewozy osobowe", "Telefony", "Tłumaczenia i redakcja tekstu", "Utylizacja", "Wypożyczalnie", "Zdrowie", "Inne usługi", "Szukam usług finansowych", "Szukam usług budowlanych", "Szukam innych usług", "Szukam kursu, lekcji, korepetycji"] },
